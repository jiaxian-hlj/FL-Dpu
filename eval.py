...
parser.add_argument('--model_type', type=str, choices=['attention_mil', 'attention_mil_surv'], default='attention_mil', 
...
if __name__ == "__main__":
    ...
    for ckpt_idx in range(len(ckpt_paths)):
        ...
        model, patient_results, test_error, auc, _,df  = eval(split_dataset, args, ckpt_paths[ckpt_idx])
